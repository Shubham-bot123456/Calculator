...
public class Calculator {
    public static void main(String[] args) {
        ...
        String immidiateAnswer = brackets(inputString);
        System.out.println(immidiateAnswer.substring(1, immidiateAnswer.length() - 1));

    }

    public static String brackets(String inputstring) {
    ...
    public static String calculator(String inputString) {
    ...
    private static int getAnswer(String inputString, int answer, int baseIndex, int rightNumber, int leftNumber) {
    ...
    public static String doubleSignOperator(String inputString) {
